      ...
      <section>
        <article>
          <div class="dashboard-video">
            <video id="dashboardVideo" src="videos/blood video.mp4" muted autoplay loop></video>
          </div>
        </article>
      </section>
    </div>
      ...
      <section>
        <article>
          <div class="dashboard-heading">
            <h2 class="Blood Hub">Blood Hub</h2>
          </div>
          <div class="dashboard-content">
            <p class="blood-info">Welcome to Blood Hub, your premier source for blood-related information and available blood samples.</p>
            <p class="blood-info">At Blood Hub, we provide comprehensive details about various blood types, their compatibility, and the significance of blood donation.</p>
            <p class="blood-info">Furthermore, we offer an extensive selection of verified blood samples. Whether you require a specific blood type or wish to contribute to our blood bank, you'll find what you need at Blood Hub.</p>
            <p class="blood-info">Explore our website to delve deeper into blood-related topics and to discover the diverse range of available blood samples.</p>
          </div>
        </article>
      </section>
    </div>
