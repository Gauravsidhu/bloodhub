        ...
        <article>
          <div class="sample-form">
            <form action="ab-.php" method="post">
              ...
              <div class="mb-3">
                <input type="text" class="form-control" name="type" id="type-a" value="AB-" readonly>
                <!-- Hidden input field to pass the "type" value -->
                <input type="hidden" name="hidden_type" value="Ab-">
              </div>
              <div class="mb-3">
                <input type="tel" class="form-control" name="number" id="number-a" placeholder="Mobile Number" required>
              </div>
              <div class="a-btn">
              <button type="submit" class="btn btn-primary a-btn" onclick="btn()">Submit</button>
