...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <h2 class="Blood Samples">Blood Samples</h2>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-4">
        <section>
          <article>
            <div class="blood-sample-details">
              <div class="blood-sample">
                <h2 class="blood-type">Blood Type: A+</h2>
                <p class="hospital-name">Hospital: Example Hospital</p>
                <p class="location">Location: City, Country</p>
                <a class="btn btn-primary" href="a+.php" role="button">Request Sample</a>
      ...
      <div class="col-md-4">
        <section>
          <article>
            <div class="blood-sample-details">
              <div class="blood-sample">
                <h2 class="blood-type">Blood Type: B+</h2>
                <p class="hospital-name">Hospital: Example Hospital</p>
                <p class="location">Location: City, Country</p>
                <a class="btn btn-primary" href="b+.php" role="button">Request Sample</a>
              </div>
            </div>
          </article>
        </section>
      ...
      <div class="col-md-4">
        <section>
          <article>
            <div class="blood-sample-details">
              <div class="blood-sample">
                <h2 class="blood-type">Blood Type: AB+</h2>
                <p class="hospital-name">Hospital: Example Hospital</p>
                <p class="location">Location: City, Country</p>
                <a class="btn btn-primary" href="ab+.php" role="button">Request Sample</a>
              </div>
            </div>
          </article>
        </section>
      ...
      <div class="col-md-4">
        <section>
          <article>
            <div class="blood-sample-details">
              <div class="blood-sample">
                <h2 class="blood-type">Blood Type: O+</h2>
                <p class="hospital-name">Hospital: Example Hospital</p>
                <p class="location">Location: City, Country</p>
                <a class="btn btn-primary" href="o+.php" role="button">Request Sample</a>
              </div>
            </div>
          </article>
        </section>
